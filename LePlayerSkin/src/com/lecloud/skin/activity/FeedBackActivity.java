...
public class FeedBackActivity extends Activity implements IFeedBackListener{
        ...
        feedBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!NetworkUtils.hasConnect(FeedBackActivity.this)) {
                    Toast.makeText(FeedBackActivity.this, "没有网络，请稍后再试", Toast.LENGTH_LONG).show();
                    return;
                }
                LeFeedBack.postFeedBack(FeedBackActivity.this, "提交反馈", "正在提交中。。。", getSubmitParameter(), FeedBackActivity.this);
            }
        });
    }
    ...
    public void feedBackFailure() {
        Toast.makeText(FeedBackActivity.this, "网络错误，反馈提交失败", Toast.LENGTH_SHORT).show();
    }
}
