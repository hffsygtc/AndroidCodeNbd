...
//                mEventCode = "" + event;
                int status = data.getInt(PlayerParams.KEY_RESULT_STATUS_CODE);
                videoTips("" + status, getText(R.string.play_fail), getText(R.string.letv_notice_message), getText(R.string.replay), getText(R.string.submit_error_info));
                break;
            case PlayerEvent.PLAY_INFO: {
                int code = data.getInt(PlayerParams.KEY_RESULT_STATUS_CODE);
