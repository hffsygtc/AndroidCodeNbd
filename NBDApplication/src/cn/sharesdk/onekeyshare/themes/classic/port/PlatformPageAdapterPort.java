...
public class PlatformPageAdapterPort extends PlatformPageAdapter {
	...
	//图标的大小
//	private static final int DESIGN_LOGO_HEIGHT = 117;
	private static final int DESIGN_LOGO_HEIGHT = 174;
	//图标距离顶部的高度
//	private static final int DESIGN_PADDING_TOP = 40;
	private static final int DESIGN_PADDING_TOP = 60;
	//图标距离顶部的高度
//	private static final int CELL_HEIGHT = 217;
	private static final int CELL_HEIGHT = 324;
...
//		cellHeight =(int) (CELL_HEIGHT * ratio);
