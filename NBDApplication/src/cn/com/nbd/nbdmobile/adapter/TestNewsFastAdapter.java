 ...
 * @author riche
 */
public class TestNewsFastAdapter extends BaseAdapter implements SectionIndexer,
		HeaderAdapter {
	...
	public TestNewsFastAdapter(Activity activity, ArrayList<ArticleInfo> newsList,boolean isDayTheme) {
	...
	private void setThemeColor(ViewHolder mHolder, boolean isDayTheme) {
		...
		if (isDayTheme) {
			ThemeUtil.setBackgroundClickDay(activity, mHolder.itemLayout);
			...
			ThemeUtil.setBackgroundClickNight(activity, mHolder.itemLayout);
