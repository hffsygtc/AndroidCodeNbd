...
//import cn.com.nbd.nbdmobile.view.MySurfaceView;
//
...
//
//public class LetvFullPlayBoard {
//
...
//		final DownloadCenter downloadCenter = DownloadCenter
//				.getInstances(mContext);
...
//				downloadCenter.setDownloadRateText(playContext
//						.getDefinationIdByType(uicontext.getCurrentRateType()));
...
//		// PlayerAssistant.loadLastPosition(playContext,
//		// mBundle.getString(PlayProxy.PLAY_UUID),
...
//
//	private void pause() {
//		if (isContinue && skinBuildType == V4PlaySkin.SKIN_TYPE_A
//				&& player != null && (int) player.getCurrentPosition() > 0) {
//			PlayerAssistant.saveLastPosition(mContext,
//					mBundle.getString(PlayProxy.PLAY_UUID),
//					mBundle.getString(PlayProxy.PLAY_VUID),
...
//		if (playContext != null) {
//			Log.e("DESTROY", "==>PLAYCONTEXT");
//			playContext.destory();
//		}
//		if (videoView != null) {
//			Log.e("DESTROY", "==>VIDEOVIEW");
//			videoView.getMysef().setVisibility(View.GONE);
//			
//		}
//		if (player != null && player.isPlaying()) {
//			Log.e("DESTROY", "==>PLAYER");
//			player.stop();
//			// release 方法有个PlayObservable回调一个值，没有判断空的情况下回调
//			if (player.getPlayObservable() != null) {
//				player.release();
//			}
//			player.reset();
//			player = null;
...
//			PlayerSkinFactory.initActionLivePlaySkin(skin,
//					V4PlaySkin.SKIN_TYPE_C,
//					mBundle.getString(PlayProxy.PLAY_ACTIONID),
//					new IActionCallback() {
//						@Override
...
//
//						@Override
//						public ISplayer createPlayerCallback(
//								SurfaceHolder holder, String path,
//								OnPlayStateListener playStateListener) {
//							return PlayerAssistant.createActionLivePlayer(
//									mContext, holder, path, playStateListener);
//						}
//					}, isPanoVideo);
//		} else {
...
//		videoView = new MySurfaceView(mContext);
//		// 初始化一个surfaceview,将holder取出监听callback
//		videoView.getHolder().addCallback(surfaceCallback);
//		videoView.setVideoContainer(null);
//		WindowManager windowManager = ((Activity)mContext).getWindowManager();
//		Display display = windowManager.getDefaultDisplay();
//		
//		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(display.getHeight(), display.getWidth());
////		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,mContext
////				.getResources().getDimensionPixelSize(
////				R.dimen.main_video_player_height));
...
//		Log.e("VIDEO_TEST", "CREAT A PLAYER ");
//		player = PlayerFactory.createOnePlayer(playContext, mBundle,
//				playStateListener, surface);
//
//		if (!TextUtils.isEmpty(path)) {
//			playContext.setUsePlayerProxy(false);
//		}
//		player.setDataSource(path);
//		// if (lastPosition > 0 && mBundle.getInt(PlayProxy.PLAY_MODE) ==
...
//			 * 活动直播
//			 */
//			PlayContext playContextAction = (PlayContext) player
//					.getPlayContext();
...
//			 * 获取码率
//			 */
//			Map<Integer, String> definationsMap = playContext
//					.getDefinationsMap();
//			Iterator<Entry<Integer, String>> it = definationsMap.entrySet()
//					.iterator();
//			while (it.hasNext()) {
...
//			if (uicontext == null || player == null
//					|| player.getPlayContext() == null) {
//				return;
//			}
//			uicontext.setVideoTitle(((PlayContext) player.getPlayContext())
//					.getVideoTitle());
//			uicontext.setDownloadable(((PlayContext) player.getPlayContext())
//					.isCanbeDownload());
//			break;
//		}
//	}
...
//			// TODO 获取当前播放的码率
//			uicontext
//					.setCurrentRateType(playContext.getCurrentDefinationType());
...
//				videoView.onVideoSizeChange(player.getVideoWidth(),
...
//			 * 检查活动直播状态
//			 */
//			PlayerAssistant.checkActionLiveStatus(player,
//					new LiveStatusCallback() {
//						@Override
...
//							LeLog.ePrint("123", "getActiveLiveStatus error ",
//									error);
//						}
//					});
//			break;
...
//	 * 重新播放
//	 */
//	public void ReplayVideo(Bundle bundle) {
//		player.setParameter(player.getPlayerId(), bundle);
//		player.prepareAsync();
//	}
//
